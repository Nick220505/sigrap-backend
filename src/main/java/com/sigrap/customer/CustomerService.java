...
public class CustomerService {
   ...
   */
  @Transactional
  @Auditable(action = "CREATE", entity = "CUSTOMER", captureDetails = true)
   ...
   * @throws EntityNotFoundException  if customer with the ID is not found
   * @throws IllegalArgumentException if trying to update to an email that's
   *                                  already taken by another customer
   */
  @Transactional
  @Auditable(action = "UPDATE", entity = "CUSTOMER", entityIdParam = "id", captureDetails = true)
   ...
   */
  @Transactional
  @Auditable(action = "DELETE", entity = "CUSTOMER", entityIdParam = "id")
   ...
   * @return List of customer information DTOs created within the specified date
   *         range
   */
  @Transactional(readOnly = true)
