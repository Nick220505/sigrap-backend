...
public class SaleReturnController {
  ...
  /**
   * Deletes multiple sales returns by their IDs.
   *
   * @param ids List of sales return IDs to delete
   */
  @DeleteMapping("/delete-many")
  @ResponseStatus(HttpStatus.NO_CONTENT)
  @Operation(
    summary = "Delete multiple sales returns",
    description = "Deletes multiple sales returns and reverts associated stock adjustments."
  )
  @ApiResponses(
    value = {
      @ApiResponse(
        responseCode = "204",
        description = "Sales returns deleted successfully"
      ),
      @ApiResponse(
        responseCode = "404",
        description = "One or more sales returns not found",
        content = @Content
      ),
    }
  )
  public void deleteAllById(
    @Parameter(
      description = "List of sales return IDs to delete",
      required = true
