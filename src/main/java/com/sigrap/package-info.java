/**
 * Root package for SIGRAP (Stationery Inventory and General Retail
 * Administration Platform).
 *
 * <p>
 * SIGRAP is a comprehensive management system designed for stationery stores,
 * providing
 * a complete solution for inventory management, sales tracking, and business
 * operations.
 * </p>
 *
 * <p>
 * The system is organized into feature-based packages:
 * <ul>
