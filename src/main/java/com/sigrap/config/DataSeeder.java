  ...
  private void seedCategories() {
    if (categoryRepository.count() == 0) {
      ...
      Category c1 = Category.builder()
          ...
          .description("Artículos básicos para estudiantes de primaria y secundaria.")
          .build();

      Category c2 = Category.builder()
          .name("Artículos de Oficina")
          .description("Suministros profesionales para el trabajo administrativo y de oficina.")
          .build();

      Category c3 = Category.builder()
          .name("Papelería General")
          .description("Papeles, sobres, cuadernos y otros artículos de uso cotidiano.")
          .build();

      Category c4 = Category.builder()
          .name("Regalos y Detalles")
          .description("Artículos decorativos, tarjetas y empaques para obsequios.")
          .build();

      Category c5 = Category.builder()
          .name("Tecnología Básica")
          .description("Accesorios de computación, almacenamiento y dispositivos sencillos.")
          .build();

      Category c6 = Category.builder()
          .name("Arte y Dibujo")
          .description("Materiales para expresión artística, dibujo técnico y manualidades creativas.")
          .build();

      Category c7 = Category.builder()
          .name("Escritura")
          .description("Bolígrafos, lápices, marcadores y otros instrumentos de escritura.")
          .build();

      Category c8 = Category.builder()
          .name("Cuadernos y Libretas")
          .description("Diversos formatos de cuadernos para diferentes usos escolares y profesionales.")
          .build();

      Category c9 = Category.builder()
          .name("Organización y Archivo")
          .description("Productos para clasificar, almacenar y organizar documentos.")
          .build();

      Category c10 = Category.builder()
          .name("Mochilas y Bolsos")
          .description("Soluciones para transportar materiales escolares y de oficina.")
          .build();

      Category c11 = Category.builder()
          .name("Material Didáctico")
          .description("Recursos educativos para facilitar el aprendizaje en diferentes áreas.")
          .build();

      Category c12 = Category.builder()
          .name("Manualidades")
          .description("Materiales diversos para proyectos creativos y decorativos.")
          .build();
  ...
  private void seedProducts() {
    if (productRepository.count() == 0) {
      ...
      Product p1 = Product.builder()
          ...
          .description("Cuaderno universitario de 100 hojas, cuadriculado, pasta dura")
      ...
      Product p3 = Product.builder()
          ...
          .description("Caja de 12 lápices de colores, punta resistente, colores vivos")
      ...
      Product p4 = Product.builder()
          ...
          .description("Kit de regla 30cm, escuadras, transportador y compás de precisión")
      ...
      Product p5 = Product.builder()
          ...
          .description("Borrador de nata, suave, no mancha el papel, alta durabilidad")
      ...
      Product p6 = Product.builder()
          ...
          .description("Grapadora metálica de escritorio, capacidad 20 hojas, color negro")
      ...
      Product p7 = Product.builder()
          ...
          .description("Perforadora metálica de 2 huecos, capacidad 20 hojas, color negro")
      ...
      Product p8 = Product.builder()
          ...
          .description("Caja con 100 clips metálicos estándar, 33mm, acabado plateado")
      ...
      Product p9 = Product.builder()
          ...
          .description("Set de 3 bandejas plásticas apilables para documentos, color negro")
      ...
      Product p10 = Product.builder()
          ...
          .description("Dispensador de cinta adhesiva de escritorio, base pesada antideslizante")
      ...
      Product p11 = Product.builder()
          ...
          .description("Resma de papel bond A4, 75g, 500 hojas, blanco, multifuncional")
          .costPrice(new BigDecimal("12000"))
      ...
      Product p14 = Product.builder()
          ...
          .description("Block de papel iris tamaño carta, 20 hojas, colores surtidos")
          .costPrice(new BigDecimal("3500"))
      ...
      Product p15 = Product.builder()
          ...
          .description("Paquete de 20 hojas de papel adhesivo blanco, tamaño carta")
          .costPrice(new BigDecimal("4000"))
      ...
      Product p16 = Product.builder()
          ...
          .description("Tarjeta de felicitación con sobre, diseños variados para toda ocasión")
          .costPrice(new BigDecimal("1500"))
      ...
      Product p18 = Product.builder()
          ...
          .description("Figura decorativa de personaje anime, 10cm de altura, varios modelos")
          .costPrice(new BigDecimal("6000"))
          .salePrice(new BigDecimal("12000"))
          .category(categories.get(3))
          .build();
      ...
      Product p19 = Product.builder()
          ...
          .description("Caja de regalo decorativa, tamaño mediano, con moño incluido")
      ...
      Product p20 = Product.builder()
          ...
          .description("Conjunto de 10 tarjetas pequeñas con mensajes motivacionales")
      ...
      Product p21 = Product.builder()
          ...
          .description("Memoria USB 16GB, conexión 2.0, carcasa plástica resistente")
      ...
      Product p22 = Product.builder()
          ...
          .description("Mouse óptico USB con cable, resolución 1000 DPI, diseño ergonómico")
          .costPrice(new BigDecimal("12000"))
          .salePrice(new BigDecimal("20000"))
          .category(categories.get(4))
          .build();
      ...
      Product p23 = Product.builder()
          ...
          .description("Funda protectora para laptop de 14 pulgadas, acolchada, impermeable")
      ...
      Product p24 = Product.builder()
          ...
          .description("Audífonos con cable, conector 3.5mm, control de volumen integrado")
          .costPrice(new BigDecimal("8000"))
          .salePrice(new BigDecimal("15000"))
          .category(categories.get(4))
          .build();
      ...
      Product p25 = Product.builder()
          ...
          .description("Adaptador conversor de HDMI a VGA, compatible con PC y dispositivos móviles")
          .costPrice(new BigDecimal("10000"))
          .salePrice(new BigDecimal("18000"))
          .category(categories.get(4))
          .build();
      ...
      Product p26 = Product.builder()
          ...
          .description("Set de 12 pastillas de acuarela con pincel incluido, colores surtidos")
      ...
      Product p27 = Product.builder()
          ...
          .description("Block de papel para acuarela, 10 hojas, 300g, tamaño A4, grano fino")
          .costPrice(new BigDecimal("6000"))
          .salePrice(new BigDecimal("12000"))
          .category(categories.get(5))
          .build();
      ...
      Product p28 = Product.builder()
          ...
          .description("Set de 5 pinceles de diferentes tamaños para técnicas húmedas")
      ...
      Product p29 = Product.builder()
          ...
          .description("Lienzo de algodón montado en bastidor de madera, 30x40cm, imprimado")
      ...
      Product p30 = Product.builder()
          ...
          .description("Set de 6 lápices de grafito para dibujo artístico, diferentes durezas")
          .costPrice(new BigDecimal("8000"))
          .salePrice(new BigDecimal("15000"))
          .category(categories.get(5))
          .build();
      ...
      Product p31 = Product.builder()
          ...
          .description("Caja de 12 bolígrafos Kilométrico 100, punta media, color azul")
          .costPrice(new BigDecimal("6000"))
          .salePrice(new BigDecimal("10000"))
      ...
      Product p32 = Product.builder()
          ...
          .description("Pluma estilográfica con cartucho recargable, cuerpo metálico, punta fina")
          .costPrice(new BigDecimal("12000"))
          .salePrice(new BigDecimal("22000"))
          .category(categories.get(6))
          .build();
      ...
      Product p33 = Product.builder()
          ...
          .description("Set de 4 marcadores permanentes, colores básicos, punta biselada")
          .costPrice(new BigDecimal("5000"))
      ...
      Product p34 = Product.builder()
          ...
          .description("Set de 5 resaltadores en colores neón, punta biselada, tinta fluorescente")
          .costPrice(new BigDecimal("6000"))
          .salePrice(new BigDecimal("11000"))
          .category(categories.get(6))
          .build();
      ...
      Product p35 = Product.builder()
          ...
          .description("Lápiz corrector líquido de secado rápido, punta metálica de precisión")
          .costPrice(new BigDecimal("2500"))
      ...
      Product p36 = Product.builder()
          ...
          .description("Cuaderno argollado de 5 materias, 200 hojas, separadores de colores")
          .costPrice(new BigDecimal("9000"))
          .salePrice(new BigDecimal("16000"))
      ...
      Product p37 = Product.builder()
          ...
          .description("Libreta de bolsillo, 80 hojas cuadriculadas, tapa dura, 9x14cm")
          .costPrice(new BigDecimal("2500"))
      ...
      Product p38 = Product.builder()
          ...
          .description("Agenda anual ejecutiva, una página por día, tapa dura, cinta separadora")
          .costPrice(new BigDecimal("15000"))
          .salePrice(new BigDecimal("25000"))
          .category(categories.get(7))
          .build();
      ...
      Product p39 = Product.builder()
          ...
          .description("Block de 5 colores neón de notas adhesivas, 100 hojas cada color")
          .costPrice(new BigDecimal("3000"))
          .salePrice(new BigDecimal("6000"))
          .category(categories.get(7))
          .build();
      ...
      Product p40 = Product.builder()
          ...
          .description("Diario personal con candado, tapa acolchada, 200 páginas, 15x21cm")
          .costPrice(new BigDecimal("12000"))
          .salePrice(new BigDecimal("20000"))
          .category(categories.get(7))
          .build();
      ...
      Product p41 = Product.builder()
          ...
          .description("Archivador AZ tamaño carta, lomo ancho, con palanca y gancho")
          .costPrice(new BigDecimal("8000"))
          .salePrice(new BigDecimal("15000"))
      ...
      Product p42 = Product.builder()
          ...
          .description("Carpeta plástica con gancho legajador, colores surtidos, tamaño carta")
      ...
      Product p43 = Product.builder()
          ...
          .description("Juego de 5 separadores plásticos, colores surtidos, tamaño carta")
          .costPrice(new BigDecimal("1500"))
          .salePrice(new BigDecimal("3000"))
          .category(categories.get(8))
          .build();
      ...
      Product p44 = Product.builder()
          ...
          .description("Caja organizadora plástica con tapa, capacidad 5 litros, transparente")
          .costPrice(new BigDecimal("7000"))
          .salePrice(new BigDecimal("12000"))
          .category(categories.get(8))
          .build();
      ...
      Product p45 = Product.builder()
          ...
          .description("Mochila escolar con 2 compartimientos, bolsillo lateral, acolchada")
      ...
      Product p46 = Product.builder()
          ...
          .description("Cartuchera de tela con cierre, capacidad para 10 lápices, diseños surtidos")
          .costPrice(new BigDecimal("4000"))
      ...
      Product p47 = Product.builder()
          ...
          .description("Ábaco de madera con cuentas de colores, 10 filas, 10 cuentas por fila")
          .costPrice(new BigDecimal("15000"))
          .salePrice(new BigDecimal("25000"))
      ...
      Product p48 = Product.builder()
          ...
          .description("Mapamundi escolar didáctico plastificado, 50x70cm, doble cara")
          .costPrice(new BigDecimal("12000"))
          .salePrice(new BigDecimal("20000"))
          .category(categories.get(10))
          .build();
      ...
      Product p49 = Product.builder()
          ...
          .description("Set de arcilla para modelar, 4 colores básicos, no tóxica, 500g")
          .costPrice(new BigDecimal("8000"))
          .salePrice(new BigDecimal("14000"))
      ...
      Product p50 = Product.builder()
          ...
          .description("Kit para elaboración de bisutería, incluye cuentas, hilos y herramientas")
          .costPrice(new BigDecimal("18000"))
          .salePrice(new BigDecimal("30000"))
          .category(categories.get(11))
          .build();
