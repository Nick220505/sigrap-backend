...
/**
 * Main Spring Boot application class for SIGRAP (Stationery Inventory and
 * General Retail Administration Platform).
 *
 * <p>
 * SIGRAP is a comprehensive management system for stationery stores, providing:
 * <ul>
 ...
 *
 * <p>
 * For API documentation, visit /swagger-ui.html when the application is
 * running.
 * </p>
 *
