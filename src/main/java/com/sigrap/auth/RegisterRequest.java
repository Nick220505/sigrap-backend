...
public class RegisterRequest {
  ...
  @Schema(description = "User's password - must be at least 8 characters with uppercase, lowercase, number and special character", example = "Password123!", required = true)
