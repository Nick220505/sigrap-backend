...
/**
 * ArchUnit tests to validate hexagonal architecture implementation for the employee module.
 * These tests ensure that architectural boundaries are respected and dependencies flow correctly.
 */
@DisplayName("Employee Module - Hexagonal Architecture Tests")
class EmployeeArchitectureTest {
        ...
        void applicationLayerShouldOnlyDependOnDomainLayer() {
            ArchRule rule = classes()
                    ...
                    .resideInAnyPackage(
                            "..application..",
                            "..domain..",
                            "..user.domain..",  // Allow dependency on user domain
                            "java..",
    ...
    class PackageStructureTests {
        ...
        void domainModelsShouldResideInDomainModelPackage() {
            ArchRule rule = classes()
                    .that().haveNameMatching(".*(?:Attendance|Schedule).*")
    ...
    class FrameworkDependencyTests {
        ...
        void domainEntitiesShouldBePurePojos() {
            ArchRule rule = classes()
                    ...
                    .and().haveNameMatching(".*(?:Attendance|Schedule).*")
                    .and().areNotInterfaces()
                    .and().areNotRecords()
                    .should().onlyDependOnClassesThat()
                    .resideInAnyPackage(
