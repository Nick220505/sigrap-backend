...
class ErrorHandlingIntegrationTest {
  ...
  void entityNotFound_shouldReturnAppropriateErrorResponse() throws Exception {
    ...
    mockMvc
      .perform(
        get("/api/products/999").header("Authorization", "Bearer " + token)
      )
  ...
  @Test
  void validationErrors_shouldReturnAppropriateErrorResponse()
    throws Exception {
    RegisterRequest registerRequest = RegisterRequest.builder()
  ...
  @Test
  void businessRuleViolation_shouldReturnAppropriateErrorResponse()
    throws Exception {
    RegisterRequest registerRequest = RegisterRequest.builder()
      .name("Duplicate User")
