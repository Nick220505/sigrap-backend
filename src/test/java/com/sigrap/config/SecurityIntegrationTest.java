...
class SecurityIntegrationTest {
  ...
  @Test
  void accessProtectedEndpoint_withoutAuthentication_shouldReturnUnauthorized()
    throws Exception {
  ...
  void accessProtectedEndpoint_withValidToken_shouldSucceed() throws Exception {
    ...
    mockMvc
      .perform(
        get("/api/categories").header("Authorization", "Bearer " + token)
      )
  ...
  @Test
  void invalidProductData_shouldReturnAppropriateErrorResponse()
    throws Exception {
    RegisterRequest registerRequest = RegisterRequest.builder()
      .name("Data Test User")
